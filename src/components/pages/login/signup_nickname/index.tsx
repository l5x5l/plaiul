        ...
        <SafeAreaView style={SignUpNicknameStyle.safeAreaView}>
            <View style={SignUpNicknameStyle.mainContainer}>
                ...
                <View style={SignUpNicknameStyle.middleArea}>
                    ...
                    <TextInput style={[textStyle.body1, { color : colors.text, paddingVertical : 8, marginTop : 96 }]}/>
                    <Line/>
                    <View style={SignUpNicknameStyle.messageArea}>
                        <Text style={[textStyle.caption, {color : colors.text}]}>사용가능한 닉네임입니다</Text>
                        <Text style={[textStyle.caption, {color : colors.text}]}>5/10</Text>
                    </View>
                </View>
