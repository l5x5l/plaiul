                        ...
                        <View style={TipDetailStyle.contentArea}>
                            {
                                tipDetail?.content.map((data, index) => (
                                    data.type === 1 ? <Text key={`text_${index}`} style={[textStyle.body2, {color : colors.text, marginBottom : 16}]}>{data.text}</Text> : <Image key={`image_${index}`} source={{uri : data.image}} style={{ marginBottom : 16, width : "100%", aspectRatio : 1}}/> 
                                ))
                            }
                        </View>
                    </View>
