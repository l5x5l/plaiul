...
import qnaSlice, { loadQna, qnaSliceState, toggleQnaLike } from "../../../redux/qna/qnaSlice";
    ...
    return (
        <View style={{ paddingHorizontal: 16 }}>
            ...
            <View style={{ flexDirection: "row", marginTop: 20, alignItems: "center" }}>
                ...
                <Pressable style={{ flexDirection: "row", alignItems: "center" }} onPress={() => {dispatch(toggleQnaLike(props.qnaIdx))}}>
